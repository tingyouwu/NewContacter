package com.future.wk.newcontacter.widget.xrecyclerview;
...
import com.future.wk.newcontacter.widget.xrecyclerview.progressindicator.AVLoadingIndicatorView;


public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {

    public static int Blue_Style = 1;
    public static int White_Style = 2;
    ...
    public void setStyle(int style){
        if(style == Blue_Style){
            mContainer.setBackgroundColor(getResources().getColor(R.color.blue));
            mStatusTextView.setTextColor(getResources().getColor(R.color.white));
            mHeaderTimeView.setTextColor(getResources().getColor(R.color.white));
            mHeaderTimeViewLabel.setTextColor(getResources().getColor(R.color.white));
            AVLoadingIndicatorView progressView = new  AVLoadingIndicatorView(this.getContext());
            progressView.setIndicatorColor(getResources().getColor(R.color.white));
            progressView.setIndicatorId(ProgressStyle.BallSpinFadeLoader);
            mProgressBar.setView(progressView);
            mArrowImageView.setImageResource(R.mipmap.ic_pulltorefresh_arrow_white);
        }else if(style == White_Style){
            mContainer.setBackgroundColor(getResources().getColor(R.color.white));
            mStatusTextView.setTextColor(getResources().getColor(R.color.black));
            mHeaderTimeView.setTextColor(getResources().getColor(R.color.black));
            mHeaderTimeViewLabel.setTextColor(getResources().getColor(R.color.black));
            AVLoadingIndicatorView progressView = new  AVLoadingIndicatorView(this.getContext());
            progressView.setIndicatorColor(0xffB5B5B5);
            progressView.setIndicatorId(ProgressStyle.BallSpinFadeLoader);
            mProgressBar.setView(progressView);
            mArrowImageView.setImageResource(R.mipmap.ic_pulltorefresh_arrow_gray);
        }
    }
